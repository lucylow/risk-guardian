  ...
  return (
    <div className="relative w-64 h-64 mx-auto">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center">
        <span className="font-display font-bold text-6xl" style={{ color: current.color, textShadow: `0 0 20px ${current.color}` }}>
          {score}
        </span>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="text-center lg:text-left animate-fade-in-up" style={{ animationDelay: "0.1s" }}>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <a href="#demo" className="btn-primary px-8 py-3.5 text-base rounded-xl inline-flex items-center justify-center gap-2 group">
                <svg className="w-5 h-5 group-hover:scale-110 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                </svg>
                Try the Demo
              </a>
              <a href="#solution" className="btn-ghost px-8 py-3.5 text-base rounded-xl inline-flex items-center justify-center gap-2 group">
                Learn More
            ...
            <div className="flex items-center gap-8 mt-10 justify-center lg:justify-start">
              {[
                ...
                <div key={s.label} className="text-center lg:text-left animate-fade-in-up" style={{ animationDelay: `${0.3 + i * 0.1}s` }}>
          ...
          {/* Right — gauge */}
          <div className="flex flex-col items-center gap-8 animate-fade-in-up" style={{ animationDelay: "0.3s" }}>
            ...
            <div className="grid grid-cols-3 gap-3 w-full max-w-xs">
              {[
                ...
                <div key={c.label} className="glass-card p-3 text-center hover:border-primary/40 transition-all duration-200 cursor-default" style={{ animationDelay: `${0.5 + i * 0.1}s` }}>
