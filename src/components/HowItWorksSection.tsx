  ...
  const steps = [
    {
      ...
      subtitle: "Real-time multi-source",
      details: [
        "Mempool scanning for pending txs targeting your pair",
        "On-chain pool reserves & depth from OneDEX",
        "Wallet history lookup via OneID reputation API",
        "Volatility signals from OnePredict forecasts",
      ],
    ...
    },
    {
      ...
      title: "AI Models",
      subtitle: "Three specialized engines",
      details: [
        "Sandwich classifier: GBM model on mempool features",
        "Liquidity scorer: Pool health regression + Monte Carlo",
        "Wallet reputation: Graph neural network via OneID",
        "All three scores synthesized into unified Safety Score",
      ],
    ...
    },
    {
      ...
      title: "Safety Score Delivered",
      subtitle: "Native wallet integration",
      details: [
        "Score (0-100) displayed in OneWallet UI",
        "Color-coded gauge: green / amber / red",
        "Plain-language explanation + actionable recommendations",
        "Optional hard block for scores below threshold",
      ],
