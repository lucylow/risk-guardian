...
function FeatureCard({ f, delay }: { f: Feature; delay: number }) {
  ...
  return (
    <div
      ...
      style={{ background: `linear-gradient(145deg, hsl(var(--surface-raised)), hsl(var(--surface)))`, transitionDelay: `${delay}ms` }}
    >
  ...
  const features: Feature[] = [
    {
      ...
      color: "hsl(var(--risk-danger))", bg: "bg-risk-danger/10", border: "border-risk-danger/20",
      title: "Sandwich Detection", subtitle: "Real-time mempool monitoring",
    ...
    },
    {
      ...
      title: "Liquidity Health", subtitle: "Pool depth & slippage analysis",
    ...
    },
    {
      ...
      title: "Wallet Reputation", subtitle: "OneID identity scoring",
          ...
          <div className="glass-card p-8 rounded-2xl">
            <div className="grid md:grid-cols-3 gap-4 items-center">
              <div className="space-y-4">
                {[
                  { label: "Sandwich Risk", score: 12 },
                  { label: "Liquidity Health", score: 91 },
                  { label: "Wallet Risk", score: 8 },
                ].map((item) => (
                  <div key={item.label} className="flex items-center gap-3">
                    ...
                    <div className="flex-1 h-2 bg-surface-highlight rounded-full overflow-hidden">
                      <div className="h-full rounded-full" style={{ width: `${item.score}%`, background: "hsl(var(--risk-safe))" }} />
                    </div>
              ...
              <div className="text-center">
                <div className="relative w-32 h-32 mx-auto">
                  <svg className="w-full h-full -rotate-90" viewBox="0 0 100 100">
                    ...
                    <circle cx="50" cy="50" r="42" fill="none" stroke="hsl(var(--risk-safe))" strokeWidth="10" strokeDasharray="264" strokeDashoffset="31.7" strokeLinecap="round" style={{ filter: "drop-shadow(0 0 8px hsl(158 64% 52%))" }} />
                  </svg>
